...
## Question
What is this invention and why does it matter?

## Prompt

Write a concise executive summary of the invention described below. This summary will be read by patent attorneys and business executives who need to quickly understand the invention's value.

**Novelty Statement:**
{novelty_statement}

**Requirements:**
- Open with a single sentence that names the invention and its primary function
- State the specific problem it solves (not a generic problem — the actual pain point)
...
- Do NOT start with "This invention relates to..." (patent boilerplate — we want clarity)
